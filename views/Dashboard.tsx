  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { icon: <Clock className="text-blue-500" />, label: 'Total Estudado', value: '142h', sub: '+12% este mês' },
          { icon: <Target className="text-green-500" />, label: 'Taxa de Acerto', value: '78.5%', sub: 'Média de 450 questões' },
          { icon: <AlertCircle className="text-orange-500" />, label: 'Revisões Pend.', value: '12', sub: 'Prioridade Alta' },
          { icon: <BookOpen className="text-purple-500" />, label: 'Progresso Edital', value: '42%', sub: '78 de 185 tópicos' }
        ].map((item, i) => (
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {MOCK_DATA.nextRevisions.map((rev) => (
                <div key={rev.id} className="flex items-center justify-between p-3 bg-slate-800 rounded-lg">
                  <div>
